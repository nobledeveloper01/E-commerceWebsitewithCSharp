        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PickupOrDelivery = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_OrderDetails_AdminProducts_ProductId",
                        column: x => x.ProductId,
                        principalTable: "AdminProducts",
                        principalColumn: "Id",
            ...
            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "Id", "DateRegistered", "Email", "FullName", "PasswordHash", "ResetToken", "ResetTokenExpires", "Role", "Status", "Username" },
                values: new object[] { 1, new DateTime(2024, 12, 4, 15, 24, 25, 52, DateTimeKind.Utc).AddTicks(6036), "admin@example.com", "Admin User", "AQAAAAIAAYagAAAAEI5PISPOjSjqwhAGjH5xGy4hHGfeMGpRXRmMrvya51LtuQL/dxEFgeGs+2R8skRT2Q==", null, null, "Admin", "Active", "admin" });
